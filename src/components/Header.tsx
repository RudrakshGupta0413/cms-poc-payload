...
export async function Header() {
  ...
  try {
    ...
    return (
      <header
        style={{
          ...
          backgroundColor: '#1a1a1a', // Ensure a consistent background
        }}
      >
        <Link
          href="/"
    ...
    return (
      <header style={{ padding: '20px 40px', borderBottom: '1px solid #eee', backgroundColor: '#1a1a1a' }}>
        <Link href="/" style={{ fontSize: '24px', fontWeight: 'bold', textDecoration: 'none', color: '#ffffff' }}>
          MyCMS
        </Link>
      </header>
    )
